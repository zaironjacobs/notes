...
import { Overlay, Popup } from '@styles/PopupConfirmationStyled'
...
const PopupConfirmation = (props) => {
    ...
    const onYes = () => {
        props.customFunction().catch((error) => {
            ...
            <Overlay>
                <Popup ref={popupNode}>
                    ...
                    <div className="buttons-wrapper">
                        <PopupButton className="confirmation-button" onClick={onYes}>
                            Yes
                        </PopupButton>
                        <PopupButton className="confirmation-button" onClick={onNo}>
                            No
                        </PopupButton>
                    </div>
                </Popup>
